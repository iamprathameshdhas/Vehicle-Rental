...
public class UserController {
    ...
    public String browseCars(@RequestParam(required = false) String carName,
        ...
        if ((carName == null || carName.trim().isEmpty()) && (owner == null || owner.trim().isEmpty()) && showAllCars == null) {
            model.addAttribute("error", "At least one field is required to search.");
        } else {
            cars = (showAllCars == null) ? carService.searchCars(carName, owner) : carService.findAll();
            if (cars.isEmpty()) {
